...
OUT_PATH = "/home/labi/ros2_ws/output/fastlio_mid360_trajectory.tum"
...
class OdomToTUM(Node):
    def __init__(self):
        ...
        self.get_logger().info(f"Writing TUM trajectory to: {OUT_PATH}")
...
def main():
    ...
    try:
        ...
        pass
    node.get_logger().info(f"Finished. Total poses written: {node.count}")
    node.out.close()
    node.destroy_node()
    rclpy.shutdown()
